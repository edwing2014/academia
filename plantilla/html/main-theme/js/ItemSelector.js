...
Ext.ux.form.ItemSelector = Ext.extend(Ext.form.Field,  {
    hideNavIcons:false,
    imagePath:"",
    iconUp:base_url+"plantilla/ux/images/up2.gif",
    iconDown:base_url+"plantilla/ux/images/down2.gif",
    iconLeft:base_url+"plantilla/ux/images/left2.gif",
    iconRight:base_url+"plantilla/ux/images/right2.gif",
    iconTop:base_url+"plantilla/ux/images/top2.gif",
    iconBottom:base_url+"plantilla/ux/images/bottom2.gif",
    drawUpIcon:true,
    drawDownIcon:true,
    drawLeftIcon:true,
    drawRightIcon:true,
    ...
    onRender: function(ct, position){
        ...
        this.toMultiselect = new Ext.ux.form.MultiSelect(Ext.applyIf(this.multiselects[1], msConfig[1]));
        this.toMultiselect.on('click', this.onRowClick, this);
