...
?>
<script src="<?=base_url().'assets/grocery_crud/themes/twitter-bootstrap/js/'.grocery_CRUD::JQUERY?>"></script>
<?php
...
?>
<script src="<?=base_url().'assets/grocery_crud/themes/twitter-bootstrap/js/libs/bootstrap/bootstrap-transition.js'?>" ></script>
<?php
...
?>
<script src="<?=base_url().'assets/grocery_crud/themes/twitter-bootstrap/js/libs/bootstrap/bootstrap-scrollspy.js'?>" ></script>
<?php
...
?>
<script src="<?=base_url().'assets/grocery_crud/themes/twitter-bootstrap/js/libs/bootstrap/bootstrap-typeahead.js'?>" ></script>
<script src="<?=base_url().'assets/grocery_crud/themes/twitter-bootstrap/js/libs/bootstrap/bootstrap-affix.js'?>" ></script>
<script src="<?=base_url().'assets/grocery_crud/themes/twitter-bootstrap/js/libs/bootstrap/application.js'?>" ></script>
<!--	JAVASCRIPTS - MODERNIZR -->
<script src="<?=base_url().'assets/grocery_crud/themes/twitter-bootstrap/js/libs/modernizr/modernizr-2.6.1.custom.js'?>" ></script>
...
<script src="<?=base_url().'assets/grocery_crud/themes/twitter-bootstrap/js/cookies.js'?>" ></script>
<!--	JAVASCRIPTS - JQUERY-FORM -->
<script src="<?=base_url().'assets/grocery_crud/themes/twitter-bootstrap/js/jquery.form.js'?>" ></script>
<!--	JAVASCRIPTS -  JQUERY-NUMERIC -->
<script src="<?=base_url().'assets/grocery_crud/themes/twitter-bootstrap/js/jquery_plugins/jquery.numeric.min.js'?>" ></script>
<!--	JAVASCRIPTS -   JQUERY-PRINT-ELEMENT -->
<script src="<?=base_url().'assets/grocery_crud/themes/twitter-bootstrap/js/libs/print-element/jquery.printElement.min.js'?>" ></script>
<!--	JAVASCRIPTS -  JQUERY FANCYBOX -->
<script src="<?=base_url().'assets/grocery_crud/themes/twitter-bootstrap/js/jquery_plugins/jquery.fancybox-1.3.4.js'?>" ></script>
<!--	JAVASCRIPTS -  JQUERY EASING-->
<script src="<?=base_url().'assets/grocery_crud/themes/twitter-bootstrap/js/jquery_plugins/jquery.easing-1.3.pack.js'?>" ></script>
<!--	JAVASCRIPTS -  twitter-bootstrap - CONFIGURAÇÕES-->
<script src="<?=base_url().'assets/grocery_crud/themes/twitter-bootstrap/js/app/twitter-bootstrap.js'?>" ></script>
<!--	JAVASCRIPTS -  JQUERY-FUNCTIONS-->
<script src="<?=base_url().'assets/grocery_crud/themes/twitter-bootstrap/js/jquery.functions.js'?>" ></script>
...
<div class="twitter-bootstrap">
	<div id="main-table-box" class="row-fluid">
		...
		<div id="options-content" class="span12">
            ...
            <?php if(uri_string() == 'g_institucion/asignaturas'){ ?>
                <a class="print-anchor btn" href="<?php echo base_url(); ?>g_institucion/asignaturas_form/0">
